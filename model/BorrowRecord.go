...
//go:generate generate_router -type "BorrowRecord" -method "First" -ignore "ItemID,BorrowDate"
//go:generate generate_router -type "BorrowRecord" -method "Create" -options "Note,ReplyDate" -ignore "Item" -minItem 0
